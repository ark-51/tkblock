...
class FrameTestWidget:
    ...
    def create(self) -> None:
        ...
        # Entry--------------------------------------------------
        entry1, _ = BlockService.create_entry(self.frame, 4, 9, 0, 2, name="entry1", width=20)
        ...
        # Listbox--------------------------------------------------
        listbox1, listbox1_var = BlockService.create_listbox(self.frame, 0, 5, 3, 10, str_value=("tkinter", "os", "datetime", "math"), name="listbox1")
        ...
        _, checkbutton1_var = BlockService.create_checkbutton(
            self.frame, 14, 20, 0, 2, name="checkbutton1", text="checkbutton1", int_value=0, command=echo_checkbutton1)
        # Radiobutton--------------------------------------------------
        _, radiobutton1_var = BlockService.create_radiobutton(self.frame, 6, 15, 5, 7, int_value=0, name="radiobutton1_1", text="radiobutton1_1", value=10)
        _, _ = BlockService.create_radiobutton(self.frame, 6, 15, 7, 10, name="radiobutton1_2", text="radiobutton1_2", value=20, variable=radiobutton1_var)
        BlockService.create_label(self.frame, 6, 15, 3, 5, name="radiobutton1_label", textvariable=radiobutton1_var)
        # Scale--------------------------------------------------
        _, scale1_var = BlockService.create_scale(self.frame, 16, 20, 5, 10, str_value="", name="scale1")
        BlockService.create_label(self.frame, 16, 20, 3, 5, name="scale1_label", textvariable=scale1_var)
        # Message--------------------------------------------------
        ...
        sc2_temp = tuple([str(x) for x in range(0, 100)] + ["aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa"])
        scrollbar2_listbox, _ = BlockService.create_listbox(self.frame, 42, 49, 0, 10, str_value=sc2_temp, name="scrollbar2_listbox")
        scrollbar2_listbox.scrollbar = BlockService.scrollbar(self.frame, x_enable=True, y_enable=True, size=15)
